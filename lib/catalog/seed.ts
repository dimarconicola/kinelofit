...
const sportsDiscoveryVerifiedAt = '2026-04-03T16:30:00+02:00';
...
export const categories: ActivityCategory[] = [
  ...
  },
  {
    ...
    visibility: 'beta',
    heroMetric: buildLocalized('Now broad enough to compare adjacent practices.', 'Ora abbastanza ampio da confrontare pratiche adiacenti.')
  }
];
...
const extraStyles: Style[] = [
  ...
  },
  {
    slug: 'calisthenics',
    categorySlug: 'movement',
    name: buildLocalized('Calisthenics', 'Calisthenics'),
    description: buildLocalized(
      'Bodyweight strength practice focused on control, balance, and progressive skill building.',
      'Pratica di forza a corpo libero focalizzata su controllo, equilibrio e progressione tecnica.'
    )
  },
  {
    slug: 'boxing-conditioning',
    categorySlug: 'movement',
    name: buildLocalized('Boxing Conditioning', 'Boxing conditioning'),
    description: buildLocalized(
      'Fitness formats built around boxing combinations, conditioning, and technical basics.',
      'Format fitness costruiti su combinazioni di boxe, condizionamento e basi tecniche.'
    )
  },
  {
    slug: 'indoor-climbing',
    categorySlug: 'movement',
    name: buildLocalized('Indoor Climbing', 'Arrampicata indoor'),
    description: buildLocalized(
      'Indoor climbing and bouldering practice with recurring club-led access windows.',
      'Pratica di arrampicata indoor e bouldering con finestre ricorrenti gestite dal club.'
    )
  },
  {
    slug: 'group-dance',
    categorySlug: 'movement',
    name: buildLocalized('Group Dance', 'Balli di gruppo'),
    description: buildLocalized(
      'Adult group dance classes centered on coordination, rhythm, and social energy.',
      'Classi di balli di gruppo per adulti tra coordinazione, ritmo ed energia sociale.'
    )
  },
  {
    slug: 'partner-dance',
    categorySlug: 'movement',
    name: buildLocalized('Partner Dance', 'Balli di coppia'),
    description: buildLocalized(
      'Partner-based dance practice for adults with recurring evening slots.',
      'Pratica di ballo di coppia per adulti con slot serali ricorrenti.'
    )
  },
  {
    slug: 'boxing',
    categorySlug: 'movement',
    name: buildLocalized('Boxing', 'Boxe'),
    description: buildLocalized(
      'Technical boxing practice with fixed class times and direct-contact gyms.',
      'Pratica di boxe tecnica con orari fissi e palestre a contatto diretto.'
    )
  },
  {
    slug: 'prepugilistica',
    categorySlug: 'movement',
    name: buildLocalized('Pre-boxing', 'Prepugilistica'),
    description: buildLocalized(
      'Preparatory boxing conditioning focused on technique, rhythm, and endurance.',
      'Preparazione pugilistica focalizzata su tecnica, ritmo e resistenza.'
    )
  },
  {
    slug: 'muay-thai',
    categorySlug: 'movement',
    name: buildLocalized('Muay Thai', 'Muay thai'),
    description: buildLocalized(
      'Stand-up striking practice and conditioning in a class-led format.',
      'Pratica di striking in piedi e conditioning in un formato guidato.'
    )
  },
  {
    slug: 'weight-room',
    categorySlug: 'movement',
    name: buildLocalized('Weight Room', 'Sala attrezzi'),
    description: buildLocalized(
      'Open gym access windows for strength and conditioning work.',
      'Finestre di accesso in sala pesi per lavoro di forza e condizionamento.'
    )
  },
  {
    slug: 'powerlifting',
    categorySlug: 'movement',
    name: buildLocalized('Powerlifting', 'Powerlifting'),
    description: buildLocalized(
      'Strength practice centered on squat, bench, and deadlift, usually managed by reservation.',
      'Pratica di forza su squat, panca e stacco, di solito gestita su prenotazione.'
    )
  },
  {
    slug: 'musical-gymnastics',
    categorySlug: 'movement',
    name: buildLocalized('Musical Gymnastics', 'Ginnastica musicale'),
    description: buildLocalized(
      'Group movement work combining rhythm, coordination, and conditioning.',
      'Lavoro motorio di gruppo che combina ritmo, coordinazione e condizionamento.'
    )
  },
  {
    slug: 'postural-gymnastics',
    categorySlug: 'movement',
    name: buildLocalized('Postural Gymnastics', 'Ginnastica posturale'),
    description: buildLocalized(
      'Posture-oriented classes focused on mobility, alignment, and low-impact strength.',
      'Classi orientate alla postura tra mobilita, allineamento e forza a basso impatto.'
    )
  },
  {
    slug: 'adult-dance',
...
const extraInstructors: Instructor[] = [
  ...
  {
    slug: 'ivanor-calisthenics-team',
    citySlug: 'palermo',
    name: 'Ivanor Calisthenics team',
    shortBio: buildLocalized(
      'Teaching team listed on the official Ivanor calisthenics timetable for adults and children.',
      'Team indicato nel palinsesto ufficiale Ivanor per calisthenics adulti e bambini.'
    ),
    specialties: ['calisthenics'],
    languages: ['Italian']
  },
  {
    slug: 'ksw-calisthenics-team',
    citySlug: 'palermo',
    name: 'KSW Calisthenics team',
    shortBio: buildLocalized(
      'Calisthenics team monitored through the KSW Palermo channels and recurring class listings.',
      'Team calisthenics monitorato tramite i canali KSW Palermo e i listati ricorrenti delle classi.'
    ),
    specialties: ['calisthenics'],
    languages: ['Italian']
  },
  {
    slug: 'k2-cross-boxe-team',
    citySlug: 'palermo',
    name: 'K2.0 Cross Boxe team',
    shortBio: buildLocalized(
      'Coaching team behind recurring cross boxe sessions in Palermo.',
      'Team che segue le sessioni ricorrenti di cross boxe a Palermo.'
    ),
    specialties: ['boxing-conditioning'],
    languages: ['Italian']
  },
  {
    slug: 'free-climbing-palermo-team',
    citySlug: 'palermo',
    name: 'Free Climbing Palermo team',
    shortBio: buildLocalized(
      'Indoor and outdoor climbing team behind recurring evening access and community practice in Palermo.',
      'Team di arrampicata indoor e outdoor dietro gli accessi serali ricorrenti e la pratica community a Palermo.'
    ),
    specialties: ['indoor-climbing'],
    languages: ['Italian']
  },
  {
    slug: 'emotions-dance-team',
    citySlug: 'palermo',
    name: 'Emotions of the Dance team',
    shortBio: buildLocalized(
      'Dance school team behind recurring adult group and partner dance slots in Palermo.',
      'Team della scuola dietro gli slot ricorrenti di balli di gruppo e di coppia a Palermo.'
    ),
    specialties: ['group-dance', 'partner-dance'],
    languages: ['Italian']
  },
  {
    slug: 'palestra-popolare-team',
    citySlug: 'palermo',
    name: 'Palestra Popolare team',
    shortBio: buildLocalized(
      'Community-led coaching team for boxing, muay thai, posture work, and strength formats in Palermo.',
      'Team community-led per boxe, muay thai, postura e formati di forza a Palermo.'
    ),
    specialties: ['boxing', 'prepugilistica', 'muay-thai', 'weight-room', 'powerlifting', 'musical-gymnastics', 'postural-gymnastics'],
    languages: ['Italian']
  },
  {
    slug: 'capoeira-zumbi-team',
    citySlug: 'palermo',
    name: 'Capoeira Zumbi team',
    shortBio: buildLocalized(
      'Palermo capoeira group with adult and youth practice tracked through public listings and community channels.',
      'Gruppo capoeira attivo a Palermo con pratica adulti e ragazzi tracciata tramite listati pubblici e canali community.'
    ),
    specialties: ['adult-capoeira', 'kids-capoeira'],
    languages: ['Italian']
  }
];
...
const extraBookingTargets: BookingTarget[] = [
  ...
  {
    slug: 'ksw-calisthenics-website',
    type: 'website',
    label: 'Visit website',
    href: 'https://palestre.fitness/it/i/14126-calisthenics-palermo-ksw-studio/'
  },
  {
    slug: 'ksw-calisthenics-instagram',
    type: 'website',
    label: 'Instagram',
    href: 'https://www.instagram.com/dc_ksw/'
  },
  {
    slug: 'calisthenics-palermo-orangogo',
    type: 'platform',
    label: 'Open class page',
    href: 'https://palestre.fitness/it/i/14126-calisthenics-palermo-ksw-studio/'
  },
  {
    slug: 'k2-cross-boxe-orangogo',
    type: 'platform',
    label: 'Open class page',
    href: 'https://www.orangogo.it/corsi/corso-di-fit-boxing-per-bambini-k2-0-a-s-d-kick-and-fitness-palermo'
  },
  {
    slug: 'free-climbing-palermo-website',
    type: 'website',
    label: 'Visit website',
    href: 'https://freeclimbingpalermo.wordpress.com/dove-siamo/'
  },
  {
    slug: 'emotions-dance-orangogo',
    type: 'platform',
    label: 'Open class page',
    href: 'https://www.orangogo.it/corsi/corso-di-danza-sportiva-per-bambini-emotions-of-the-dance-palermo-2'
  },
  {
    slug: 'cuba-boxing-phone',
    type: 'phone',
    label: 'Call Cuba Boxing',
    href: 'tel:+393804358445'
  },
  {
    slug: 'cuba-boxing-website',
    type: 'website',
    label: 'Visit website',
    href: 'https://www.cubaboxing.it/contatti'
  },
  {
    slug: 'palestra-popolare-facebook',
    type: 'website',
    label: 'Facebook',
    href: 'https://www.facebook.com/palestrapopolarepa/'
  },
  {
    slug: 'capoeira-zumbi-website',
    type: 'website',
    label: 'Visit website',
    href: 'https://www.capoeirazumbi.org/'
  },
  {
    slug: 'capoeira-zumbi-facebook',
    type: 'website',
    label: 'Facebook',
    href: 'https://www.facebook.com/capoeirazumbi/'
  }
];
...
const extraVenues: Venue[] = [
  ...
  {
    slug: 'ksw-calisthenics-studio',
    citySlug: 'palermo',
    neighborhoodSlug: 'pallavicino',
    name: 'KSW Calisthenics Studio',
    tagline: buildLocalized(
      'Dedicated calisthenics studio in north-west Palermo.',
      'Studio dedicato al calisthenics nella Palermo nord-ovest.'
    ),
    description: buildLocalized(
      'KSW focuses on bodyweight strength and evening adult calisthenics practice, supported by active social channels.',
      'KSW si concentra su forza a corpo libero e pratica serale di calisthenics per adulti, sostenuta da canali social attivi.'
    ),
    address: 'Via Casimiro Drago 3, Palermo',
    geo: { lat: 38.1753626, lng: 13.3005441 },
    amenities: ['Bodyweight rigs', 'Evening slots', 'Adult practice'],
    languages: ['Italian'],
    styleSlugs: ['calisthenics'],
    categorySlugs: ['movement'],
    bookingTargetOrder: ['ksw-calisthenics-website', 'ksw-calisthenics-instagram', 'calisthenics-palermo-orangogo'],
    freshnessNote: buildLocalized(
      'Official studio listing and public social channels checked on 2026-04-03.',
      'Scheda studio ufficiale e canali social pubblici controllati il 2026-04-03.'
    ),
    sourceUrl: 'https://palestre.fitness/it/i/14126-calisthenics-palermo-ksw-studio/',
    lastVerifiedAt: sportsDiscoveryVerifiedAt
  },
  {
    slug: 'k2-kick-and-fitness-palermo',
    citySlug: 'palermo',
    neighborhoodSlug: 'liberta',
    name: 'K2.0 A.S.D. Kick and Fitness',
    tagline: buildLocalized(
      'Evening cross boxe fitness classes in Palermo.',
      'Classi serali di cross boxe fitness a Palermo.'
    ),
    description: buildLocalized(
      'K2.0 runs recurring cross boxe sessions blending kickboxing basics, conditioning, and bodyweight work.',
      'K2.0 propone sessioni ricorrenti di cross boxe tra basi di kickboxing, conditioning e lavoro a corpo libero.'
    ),
    address: 'Viale Lazio 51, Palermo',
    geo: { lat: 38.1435833, lng: 13.3423821 },
    amenities: ['Evening slots', 'Group fitness', 'Combat conditioning'],
    languages: ['Italian'],
    styleSlugs: ['boxing-conditioning'],
    categorySlugs: ['movement'],
    bookingTargetOrder: ['k2-cross-boxe-orangogo'],
    freshnessNote: buildLocalized(
      'Recurring cross boxe schedule checked on 2026-04-03.',
      'Orari ricorrenti cross boxe controllati il 2026-04-03.'
    ),
    sourceUrl: 'https://www.orangogo.it/corsi/corso-di-fit-boxing-per-bambini-k2-0-a-s-d-kick-and-fitness-palermo',
    lastVerifiedAt: sportsDiscoveryVerifiedAt
  },
  {
    slug: 'free-climbing-palermo',
    citySlug: 'palermo',
    neighborhoodSlug: 'sampolo',
    name: 'Free Climbing Palermo',
    tagline: buildLocalized(
      'Indoor and outdoor climbing community with recurring access in Palermo.',
      'Community di arrampicata indoor e outdoor con accessi ricorrenti a Palermo.'
    ),
    description: buildLocalized(
      'Free Climbing Palermo publishes recurring gym access windows for indoor and outdoor climbing practice.',
      'Free Climbing Palermo pubblica finestre ricorrenti di accesso in palestra per pratica indoor e outdoor.'
    ),
    address: 'Via Andrea Cirrincione 63, Palermo',
    geo: { lat: 38.146043, lng: 13.354041 },
    amenities: ['Indoor wall', 'Outdoor community', 'Evening access'],
    languages: ['Italian'],
    styleSlugs: ['indoor-climbing'],
    categorySlugs: ['movement'],
    bookingTargetOrder: ['free-climbing-palermo-website'],
    freshnessNote: buildLocalized(
      'Official opening hours and venue map checked on 2026-04-03.',
      'Orari ufficiali e mappa sede controllati il 2026-04-03.'
    ),
    sourceUrl: 'https://freeclimbingpalermo.wordpress.com/dove-siamo/',
    lastVerifiedAt: sportsDiscoveryVerifiedAt
  },
  {
    slug: 'emotions-of-the-dance',
    citySlug: 'palermo',
    neighborhoodSlug: 'citywide',
    name: 'Emotions of the Dance',
    tagline: buildLocalized(
      'Adult partner and group dance in west Palermo.',
      'Balli di coppia e di gruppo per adulti nella Palermo ovest.'
    ),
    description: buildLocalized(
      'Dance school with recurring adult evening slots for partner dance and group dance formats.',
      'Scuola di danza con slot serali ricorrenti per adulti tra balli di coppia e balli di gruppo.'
    ),
    address: 'Via Leonardo da Vinci 394, Palermo',
    geo: { lat: 38.126642, lng: 13.315992 },
    amenities: ['Evening classes', 'Adult groups', 'Structured schedule'],
    languages: ['Italian'],
    styleSlugs: ['group-dance', 'partner-dance'],
    categorySlugs: ['movement'],
    bookingTargetOrder: ['emotions-dance-orangogo'],
    freshnessNote: buildLocalized(
      'Recurring dance schedule checked on 2026-04-03.',
      'Orari ricorrenti danza controllati il 2026-04-03.'
    ),
    sourceUrl: 'https://www.orangogo.it/corsi/corso-di-danza-sportiva-per-bambini-emotions-of-the-dance-palermo-2',
    lastVerifiedAt: sportsDiscoveryVerifiedAt
  },
  {
    slug: 'cuba-boxing-palermo',
    citySlug: 'palermo',
    neighborhoodSlug: 'citywide',
    name: 'Cuba Boxing',
    tagline: buildLocalized(
      'Long-running boxing gym with direct contact and public opening hours.',
      'Palestra di boxe con contatto diretto e orari pubblici.'
    ),
    description: buildLocalized(
      'Cuba Boxing publishes contact details, opening hours, and boxing-focused training services from its Palermo gym.',
      'Cuba Boxing pubblica contatti, orari di apertura e servizi di allenamento boxe dalla sua palestra palermitana.'
    ),
    address: 'Via Olanda 26, Palermo',
    geo: { lat: 38.1521441, lng: 13.3292218 },
    amenities: ['Boxing gym', 'Direct contact', 'Weekday opening hours'],
    languages: ['Italian', 'Spanish'],
    styleSlugs: ['boxing-conditioning'],
    categorySlugs: ['movement'],
    bookingTargetOrder: ['cuba-boxing-phone', 'cuba-boxing-website'],
    freshnessNote: buildLocalized(
      'Official contact page, opening hours, and social links checked on 2026-04-03.',
      'Pagina contatti ufficiale, orari e link social controllati il 2026-04-03.'
    ),
    sourceUrl: 'https://www.cubaboxing.it/contatti',
    lastVerifiedAt: sportsDiscoveryVerifiedAt
  },
  {
    slug: 'palestra-popolare-palermo',
    citySlug: 'palermo',
    neighborhoodSlug: 'citywide',
    name: 'Palestra Popolare Palermo',
    tagline: buildLocalized(
      'Community gym for boxing, muay thai, posture work, and strength training.',
      'Palestra popolare per boxe, muay thai, postura e lavoro di forza.'
    ),
    description: buildLocalized(
      'Palestra Popolare Palermo publishes a broad 2025/26 community timetable with boxing, muay thai, prepugilistica, postural formats, and open weight-room access.',
      'Palestra Popolare Palermo pubblica un palinsesto community 2025/26 con boxe, muay thai, prepugilistica, lavoro posturale e accesso alla sala attrezzi.'
    ),
    address: 'Via San Basilio 17, Palermo',
    geo: { lat: 38.1188723, lng: 13.3610391 },
    amenities: ['Community gym', 'Monthly pricing', 'Weight room access'],
    languages: ['Italian'],
    styleSlugs: ['boxing', 'prepugilistica', 'muay-thai', 'weight-room', 'powerlifting', 'musical-gymnastics', 'postural-gymnastics'],
    categorySlugs: ['movement'],
    bookingTargetOrder: ['palestra-popolare-facebook'],
    freshnessNote: buildLocalized(
      '2025/26 timetable checked on 2026-04-03 from the public Facebook page.',
      'Palinsesto 2025/26 controllato il 2026-04-03 dalla pagina Facebook pubblica.'
    ),
  ...
  },
  {
    ...
    tagline: buildLocalized(
      'Capoeira adulta e ragazzi in una sede stabile a Palermo.',
      'Adult and youth capoeira in a stable Palermo venue.'
    ),
    description: buildLocalized(
      'Capoeira Zumbi runs recurring practice in Palermo with adult and younger groups, supported by official and community channels.',
      'Capoeira Zumbi propone pratica ricorrente a Palermo con gruppi adulti e ragazzi, supportata da canali ufficiali e community.'
    ),
    address: 'Via Danimarca 52, Palermo',
    geo: { lat: 38.1540288, lng: 13.3311013 },
    amenities: ['Capoeira', 'Youth practice', 'Community-led'],
    languages: ['Italian'],
    styleSlugs: ['adult-capoeira', 'kids-capoeira'],
    categorySlugs: ['movement', 'kids-activities'],
    bookingTargetOrder: ['capoeira-zumbi-website', 'capoeira-zumbi-facebook'],
    freshnessNote: buildLocalized(
...
const extraRecurringSessions: RecurringSessionTemplate[] = [
  ...
  {
    templateId: 'ivanor-mon-calisthenics-1400',
    citySlug: 'palermo',
    venueSlug: 'centro-sportivo-ivanor',
    instructorSlug: 'ivanor-calisthenics-team',
    categorySlug: 'movement',
    styleSlug: 'calisthenics',
    title: buildLocalized('Calisthenics Adults', 'Calisthenics adulti'),
    weekday: 'Monday',
    startTime: '14:00',
    endTime: '15:30',
    level: 'open',
    language: 'Italian',
    format: 'in_person',
    bookingTargetSlug: 'centro-sportivo-ivanor-whatsapp',
  ...
  {
    templateId: 'ivanor-mon-calisthenics-1700',
    citySlug: 'palermo',
    venueSlug: 'centro-sportivo-ivanor',
    instructorSlug: 'ivanor-calisthenics-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'ivanor-mon-calisthenics-1830',
    citySlug: 'palermo',
    venueSlug: 'centro-sportivo-ivanor',
    instructorSlug: 'ivanor-calisthenics-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'ivanor-sat-calisthenics-1030',
    citySlug: 'palermo',
    venueSlug: 'centro-sportivo-ivanor',
    instructorSlug: 'ivanor-calisthenics-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'ksw-mon-calisthenics-2000',
    citySlug: 'palermo',
    venueSlug: 'ksw-calisthenics-studio',
    instructorSlug: 'ksw-calisthenics-team',
    categorySlug: 'movement',
    styleSlug: 'calisthenics',
    title: buildLocalized('Calisthenics Adult Class', 'Calisthenics adulti'),
    weekday: 'Monday',
    startTime: '20:00',
    endTime: '21:30',
    level: 'open',
    language: 'Italian',
    format: 'in_person',
    bookingTargetSlug: 'ksw-calisthenics-instagram',
    sourceUrl: 'https://palestre.fitness/it/i/14126-calisthenics-palermo-ksw-studio/',
    lastVerifiedAt: sportsDiscoveryVerifiedAt,
    verificationStatus: 'verified',
    audience: 'adults',
  ...
  {
    templateId: 'ksw-wed-calisthenics-2000',
    citySlug: 'palermo',
    venueSlug: 'ksw-calisthenics-studio',
    instructorSlug: 'ksw-calisthenics-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'ksw-fri-calisthenics-2000',
    citySlug: 'palermo',
    venueSlug: 'ksw-calisthenics-studio',
    instructorSlug: 'ksw-calisthenics-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'k2-tue-cross-boxe-1930',
    citySlug: 'palermo',
    venueSlug: 'k2-kick-and-fitness-palermo',
    instructorSlug: 'k2-cross-boxe-team',
    categorySlug: 'movement',
    styleSlug: 'boxing-conditioning',
    title: buildLocalized('Cross Boxe', 'Cross boxe'),
    weekday: 'Tuesday',
    startTime: '19:30',
    endTime: '20:30',
    level: 'open',
    language: 'Italian',
    format: 'in_person',
    bookingTargetSlug: 'k2-cross-boxe-orangogo',
    sourceUrl: 'https://www.orangogo.it/corsi/corso-di-fit-boxing-per-bambini-k2-0-a-s-d-kick-and-fitness-palermo',
    lastVerifiedAt: sportsDiscoveryVerifiedAt,
    verificationStatus: 'verified',
    audience: 'adults',
  ...
  {
    templateId: 'k2-thu-cross-boxe-1930',
    citySlug: 'palermo',
    venueSlug: 'k2-kick-and-fitness-palermo',
    instructorSlug: 'k2-cross-boxe-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'free-climbing-mon-evening',
    citySlug: 'palermo',
    venueSlug: 'free-climbing-palermo',
    instructorSlug: 'free-climbing-palermo-team',
    categorySlug: 'movement',
    styleSlug: 'indoor-climbing',
    title: buildLocalized('Indoor Climbing Practice', 'Pratica di arrampicata indoor'),
    weekday: 'Monday',
    startTime: '19:30',
    endTime: '22:00',
    level: 'open',
    language: 'Italian',
    format: 'in_person',
    bookingTargetSlug: 'free-climbing-palermo-website',
    sourceUrl: 'https://freeclimbingpalermo.wordpress.com/dove-siamo/',
    lastVerifiedAt: sportsDiscoveryVerifiedAt,
    verificationStatus: 'verified',
    audience: 'mixed',
  ...
  {
    templateId: 'free-climbing-tue-evening',
    citySlug: 'palermo',
    venueSlug: 'free-climbing-palermo',
    instructorSlug: 'free-climbing-palermo-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'free-climbing-wed-evening',
    citySlug: 'palermo',
    venueSlug: 'free-climbing-palermo',
    instructorSlug: 'free-climbing-palermo-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'free-climbing-thu-midday',
    citySlug: 'palermo',
    venueSlug: 'free-climbing-palermo',
    instructorSlug: 'free-climbing-palermo-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'free-climbing-thu-evening',
    citySlug: 'palermo',
    venueSlug: 'free-climbing-palermo',
    instructorSlug: 'free-climbing-palermo-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'emotions-mon-group-dance-1730',
    citySlug: 'palermo',
    venueSlug: 'emotions-of-the-dance',
    instructorSlug: 'emotions-dance-team',
    categorySlug: 'movement',
    styleSlug: 'group-dance',
    title: buildLocalized('Group Dance', 'Balli di gruppo'),
    weekday: 'Monday',
    startTime: '17:30',
    endTime: '18:30',
    level: 'open',
    language: 'Italian',
    format: 'in_person',
    bookingTargetSlug: 'emotions-dance-orangogo',
  ...
  {
    templateId: 'emotions-wed-group-dance-1730',
    citySlug: 'palermo',
    venueSlug: 'emotions-of-the-dance',
    instructorSlug: 'emotions-dance-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'emotions-fri-group-dance-1730',
    citySlug: 'palermo',
    venueSlug: 'emotions-of-the-dance',
    instructorSlug: 'emotions-dance-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'emotions-tue-partner-dance-2030',
    citySlug: 'palermo',
    venueSlug: 'emotions-of-the-dance',
    instructorSlug: 'emotions-dance-team',
    categorySlug: 'movement',
    styleSlug: 'partner-dance',
    title: buildLocalized('Partner Dance', 'Balli di coppia'),
    weekday: 'Tuesday',
    startTime: '20:30',
    endTime: '22:00',
    level: 'open',
  ...
  {
    templateId: 'emotions-thu-partner-dance-2030',
    citySlug: 'palermo',
    venueSlug: 'emotions-of-the-dance',
    instructorSlug: 'emotions-dance-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-mon-boxe-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
    styleSlug: 'boxing',
    title: buildLocalized('Boxing', 'Boxe'),
    weekday: 'Monday',
    startTime: '18:30',
    endTime: '19:30',
    level: 'open',
    language: 'Italian',
    format: 'in_person',
    bookingTargetSlug: 'palestra-popolare-facebook',
    sourceUrl: 'https://www.facebook.com/palestrapopolarepa/',
    lastVerifiedAt: sportsDiscoveryVerifiedAt,
    verificationStatus: 'verified',
    audience: 'adults',
    attendanceModel: 'cycle',
    priceNote: buildLocalized('Monthly membership EUR 30.', 'Mensile 30 EUR.')
  },
  {
    templateId: 'palestra-popolare-wed-boxe-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-thu-boxe-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-fri-boxe-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-mon-prepugilistica-2000',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
    styleSlug: 'prepugilistica',
    title: buildLocalized('Pre-boxing', 'Prepugilistica'),
    weekday: 'Monday',
    startTime: '20:00',
    endTime: '21:00',
    level: 'open',
  ...
  {
    templateId: 'palestra-popolare-wed-prepugilistica-2000',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-fri-prepugilistica-2000',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-mon-muaythai-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
    styleSlug: 'muay-thai',
    title: buildLocalized('Muay Thai', 'Muay thai'),
    weekday: 'Monday',
    startTime: '18:30',
    endTime: '19:30',
    level: 'open',
  ...
  {
    templateId: 'palestra-popolare-wed-muaythai-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-thu-muaythai-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-fri-muaythai-1830',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-mon-weightroom-1700',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
    styleSlug: 'weight-room',
    title: buildLocalized('Weight Room Access', 'Sala attrezzi'),
    weekday: 'Monday',
    startTime: '17:00',
    endTime: '21:00',
    level: 'open',
  ...
  {
    templateId: 'palestra-popolare-wed-weightroom-1700',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-thu-weightroom-1700',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-fri-weightroom-1700',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-mon-musical-1800',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
    styleSlug: 'musical-gymnastics',
    title: buildLocalized('Musical Gymnastics', 'Ginnastica musicale'),
    weekday: 'Monday',
    startTime: '18:00',
    endTime: '19:00',
    level: 'beginner',
  ...
  {
    templateId: 'palestra-popolare-wed-musical-1800',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-thu-musical-1800',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'palestra-popolare-tue-postural-1700',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
    styleSlug: 'postural-gymnastics',
    title: buildLocalized('Postural Gymnastics', 'Ginnastica posturale'),
    weekday: 'Tuesday',
    startTime: '17:00',
    endTime: '18:00',
    level: 'beginner',
  ...
  {
    templateId: 'palestra-popolare-thu-postural-1700',
    citySlug: 'palermo',
    venueSlug: 'palestra-popolare-palermo',
    instructorSlug: 'palestra-popolare-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'capoeira-zumbi-mon-adult-1930',
    citySlug: 'palermo',
    venueSlug: 'capoeira-zumbi-palermo',
    instructorSlug: 'capoeira-zumbi-team',
    categorySlug: 'movement',
    styleSlug: 'adult-capoeira',
    title: buildLocalized('Capoeira Adults', 'Capoeira adulti'),
    weekday: 'Monday',
    startTime: '19:30',
    endTime: '21:00',
    level: 'open',
  ...
  {
    templateId: 'capoeira-zumbi-wed-adult-1930',
    citySlug: 'palermo',
    venueSlug: 'capoeira-zumbi-palermo',
    instructorSlug: 'capoeira-zumbi-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'capoeira-zumbi-fri-adult-1930',
    citySlug: 'palermo',
    venueSlug: 'capoeira-zumbi-palermo',
    instructorSlug: 'capoeira-zumbi-team',
    categorySlug: 'movement',
  ...
  {
    templateId: 'capoeira-zumbi-tue-kids-1630',
    citySlug: 'palermo',
    venueSlug: 'capoeira-zumbi-palermo',
    instructorSlug: 'capoeira-zumbi-team',
    categorySlug: 'kids-activities',
    styleSlug: 'kids-capoeira',
    title: buildLocalized('Capoeira Kids', 'Capoeira bambini'),
    weekday: 'Tuesday',
    startTime: '16:30',
    endTime: '17:30',
    level: 'beginner',
  ...
  {
    templateId: 'capoeira-zumbi-thu-kids-1630',
    citySlug: 'palermo',
    venueSlug: 'capoeira-zumbi-palermo',
    instructorSlug: 'capoeira-zumbi-team',
    categorySlug: 'kids-activities',
